...
def init_db():
    ...
    with get_db_connection() as conn:
        ...
        firmware_types = [
            ...
            ('DC-SCM', 'BMC', 'Baseboard Management Controller'),
            ...
            ('DC-SCM', 'BMCTip', 'BMC Tip'),
            ('DC-SCM', 'BMCTip PCD Platform ID', 'BMC Tip PCD Platform ID'),
            ('DC-SCM', 'BMCTip PCD Version', 'BMC Tip PCD Version'),
            ('DC-SCM', 'Manticore', 'Manticore Firmware'),
            ('DC-SCM', 'CFM PlatformID', 'CFM Platform ID'),
            ('DC-SCM', 'CFMVersion ID', 'CFM Version ID'),
            ...
            ('Other Platform', 'E.1s(primary)', 'E.1s Primary Storage'),
            ('Other Platform', 'E.1s (Secondary)', 'E.1s Secondary Storage'),
            ('Other Platform', 'M.2(Primary)', 'M.2 Primary Storage'),
            ('Other Platform', 'M.2(Secondary)', 'M.2 Secondary Storage'),
            
            # OVL2 firmware types
            ('OVL2', 'OVL2 (overall package #)', 'OVL2 Overall Package'),
            ('OVL2', 'FPGA Agilex (App Image w/ OpRom)', 'FPGA Agilex Application Image with Option ROM'),
            ('OVL2', 'FPGA Agilex (Sonic Basic)', 'FPGA Agilex Sonic Basic'),
            ('OVL2', 'Cyclone V Image', 'Cyclone V FPGA Image'),
            ('OVL2', 'Cyclone V PFMID', 'Cyclone V Platform Firmware ID'),
            ('OVL2', 'Cyclone V PFM Platform ID', 'Cyclone V PFM Platform ID'),
            ('OVL2', 'OVL SOC FIP', 'OVL SOC Firmware Image Package'),
            ('OVL2', 'OVL SOC FIP PFMID', 'OVL SOC FIP Platform Firmware ID'),
            ('OVL2', 'OVL SOC FIP PFM Platform ID', 'OVL SOC FIP PFM Platform ID'),
            ...
            ('OVL2', 'SOC FPGA Tools', 'SOC FPGA Tools'),
            ('OVL2', 'FPGAsec Tool', 'FPGA Security Tool'),
